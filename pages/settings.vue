<template>
  <div class="flex flex-col w-full py-4 relative h-screen">
   ...
   <button @click="logOutUser" class="p-2 w-full mb-2 -mx-2 hover:bg-gray-500 bg-black border-2 border-white dark:text-red-500 text-red-500 dark:border-black dark:bg-white absolute bottom-0">Log out</button>
  </div>
</template>
