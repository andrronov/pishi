<template>
   <!-- <div v-if="show" class="relative">
      <div class="flex flex-row text-red-400 dark:text-red-600 font-medium bg-gray-300 dark:bg-gray-700 absolute top-1 right-5">
         <NuxtIcon name="trash" />
         <p>Delete post</p>
      </div>
    </div> -->
              ...
              <div class="relative transform overflow-hidden text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                <div class="bg-black dark:bg-gray-100 px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div class="flex flex-col items-center">
                     <div @click="deletePost" class="flex flex-row items-center p-3 bg-red-700 hover:bg-red-900 cursor-pointer border-2 text-white border-white dark:border-black font-medium">
                        <NuxtIcon name="trash" />
                        <p>Delete post</p>
                     </div>
                  </div>
